defmodule Runcom.StepNode do
  ...
  """
  @spec new(String.t(), module(), keyword() | map()) :: t()
  def new(name, module, opts) when is_list(opts) do
    new(name, module, Map.new(opts))
  end

  def new(name, module, opts) when is_map(opts) do
    %__MODULE__{
      name: name,
      module: module,
      opts: opts
