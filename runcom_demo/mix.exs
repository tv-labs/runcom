defmodule RuncomDemo.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:dns_cluster, "~> 0.2.0"},
      {:bandit, "~> 1.5"},
      {:tidewave, "~> 0.5", warn_if_outdated: true, only: :dev},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind runcom_demo", "esbuild runcom_demo"],
      "assets.deploy": [
        "tailwind runcom_demo --minify",
